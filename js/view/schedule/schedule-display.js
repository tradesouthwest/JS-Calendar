...
ScheduleDisplay.prototype = {
    init: function(calendar, due, type) {
        //TODO:dueYou need to add a function that gets schedules for a certain period using and type.
        // TODO: data.jsChange the schedule saved in the file to the import format.
        this.keys = [];
    ...
    setEvents: function() {
        for (var i = 0; i < this.scheduleArray.length; i++) {
            ...
            for (var j = 0; j < schedules.length; j++) {
                ...
                if (this.schedule.length === 0) continue; // If an empty object is included, no event is displayed.
    ...
    getThisMonthEvent: function(date) {
        ...
        for (var i = 0; i < localStorage.length; i++) {
            ...
            var order = []; // Events to show this month
